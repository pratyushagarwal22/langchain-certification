...
// Mirrors deepagents' AsyncTask TypedDict (python/m5/sales_assistant_sandbox,
// deepagents.middleware.async_subagents) — one entry per launched
// genre-researcher task, keyed by task_id.
export type AsyncTask = {
  ...
  // Not part of deepagents' stock AsyncTask — added by this project's custom
  // start_async_task tool (python/m5/sales_assistant_sandbox/async_research.py)
  // so the task list can show "Rock", "Latin", ... instead of a bare task ID.
  label?: string;
};
